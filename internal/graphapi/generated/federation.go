...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Instance":
			resolverName, err := entityResolverNameForInstance(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Instance": %w`, err)
			}
			switch resolverName {

			case "findInstanceByID":
				id0, err := ec.unmarshalNID2goᚗinfratographerᚗcomᚋinstanceᚑapiᚋxthingsᚋidxᚐPrefixedID(ctx, rep["id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findInstanceByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindInstanceByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Instance": %w`, err)
				}
		...
		case "InstanceMetadata":
			resolverName, err := entityResolverNameForInstanceMetadata(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "InstanceMetadata": %w`, err)
			}
			switch resolverName {
			...
			case "findInstanceMetadataByID":
				...
				entity, err := ec.resolvers.Entity().FindInstanceMetadataByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "InstanceMetadata": %w`, err)
				}
		...
		case "InstanceProvider":
			resolverName, err := entityResolverNameForInstanceProvider(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "InstanceProvider": %w`, err)
			}
			switch resolverName {
			...
			case "findInstanceProviderByID":
				...
				entity, err := ec.resolvers.Entity().FindInstanceProviderByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "InstanceProvider": %w`, err)
				}
...
func entityResolverNameForInstance(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findInstanceByID", nil
	}
	return "", fmt.Errorf("%w for Instance", ErrTypeNotFound)
}

func entityResolverNameForInstanceMetadata(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findInstanceMetadataByID", nil
	}
	return "", fmt.Errorf("%w for InstanceMetadata", ErrTypeNotFound)
}

func entityResolverNameForInstanceProvider(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findInstanceProviderByID", nil
	}
	return "", fmt.Errorf("%w for InstanceProvider", ErrTypeNotFound)
}
