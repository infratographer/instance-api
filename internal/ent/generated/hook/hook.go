...
type InstanceFunc func(context.Context, *generated.InstanceMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f InstanceFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.InstanceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.InstanceMutation", m)
}

// The InstanceMetadataFunc type is an adapter to allow the use of ordinary
// function as InstanceMetadata mutator.
type InstanceMetadataFunc func(context.Context, *generated.InstanceMetadataMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f InstanceMetadataFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.InstanceMetadataMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.InstanceMetadataMutation", m)
}

// The InstanceProviderFunc type is an adapter to allow the use of ordinary
// function as InstanceProvider mutator.
type InstanceProviderFunc func(context.Context, *generated.InstanceProviderMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f InstanceProviderFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.InstanceProviderMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.InstanceProviderMutation", m)
}
