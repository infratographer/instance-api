...
func (f InstanceOrderField) String() string {
	...
	case InstanceOrderFieldName.column:
		str = "NAME"
	case InstanceOrderFieldCreatedAt.column:
		str = "CREATED_AT"
	case InstanceOrderFieldUpdatedAt.column:
		str = "UPDATED_AT"
	}
	return str
}
...
var (
	...
	// InstanceMetadataOrderFieldCreatedAt orders InstanceMetadata by created_at.
	InstanceMetadataOrderFieldCreatedAt = &InstanceMetadataOrderField{
		Value: func(im *InstanceMetadata) (ent.Value, error) {
			return im.CreatedAt, nil
		},
		column: instancemetadata.FieldCreatedAt,
		toTerm: instancemetadata.ByCreatedAt,
		toCursor: func(im *InstanceMetadata) Cursor {
			return Cursor{
				ID:    im.ID,
				Value: im.CreatedAt,
	...
	// InstanceMetadataOrderFieldUpdatedAt orders InstanceMetadata by updated_at.
	InstanceMetadataOrderFieldUpdatedAt = &InstanceMetadataOrderField{
		Value: func(im *InstanceMetadata) (ent.Value, error) {
			return im.UpdatedAt, nil
		},
		column: instancemetadata.FieldUpdatedAt,
		toTerm: instancemetadata.ByUpdatedAt,
		toCursor: func(im *InstanceMetadata) Cursor {
			return Cursor{
				ID:    im.ID,
				Value: im.UpdatedAt,
...
func (f InstanceMetadataOrderField) String() string {
	...
	case InstanceMetadataOrderFieldNamespace.column:
		str = "NAME"
	case InstanceMetadataOrderFieldCreatedAt.column:
		str = "CREATED_AT"
	case InstanceMetadataOrderFieldUpdatedAt.column:
		str = "UPDATED_AT"
	}
	return str
}
...
func (f *InstanceMetadataOrderField) UnmarshalGQL(v interface{}) error {
	...
	case "CREATED_AT":
		*f = *InstanceMetadataOrderFieldCreatedAt
	case "UPDATED_AT":
		*f = *InstanceMetadataOrderFieldUpdatedAt
	default:
