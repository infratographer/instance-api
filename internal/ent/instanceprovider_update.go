...
func (ipu *InstanceProviderUpdate) AddInstanceIDs(ids ...uuid.UUID) *InstanceProviderUpdate {
...
func (ipu *InstanceProviderUpdate) RemoveInstanceIDs(ids ...uuid.UUID) *InstanceProviderUpdate {
...
func (ipu *InstanceProviderUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(instanceprovider.Table, instanceprovider.Columns, sqlgraph.NewFieldSpec(instanceprovider.FieldID, field.TypeUUID))
...
// AddInstanceIDs adds the "instances" edge to the Instance entity by IDs.
func (ipuo *InstanceProviderUpdateOne) AddInstanceIDs(ids ...uuid.UUID) *InstanceProviderUpdateOne {
...
// RemoveInstanceIDs removes the "instances" edge to Instance entities by IDs.
func (ipuo *InstanceProviderUpdateOne) RemoveInstanceIDs(ids ...uuid.UUID) *InstanceProviderUpdateOne {
...
func (ipuo *InstanceProviderUpdateOne) sqlSave(ctx context.Context) (_node *InstanceProvider, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "InstanceProvider.id" for update`)}
	}
