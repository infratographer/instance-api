...
func InstanceID(v uuid.UUID) predicate.InstanceMetadata {
...
func InstanceIDEQ(v uuid.UUID) predicate.InstanceMetadata {
	return predicate.InstanceMetadata(sql.FieldEQ(FieldInstanceID, v))
}

// InstanceIDNEQ applies the NEQ predicate on the "instance_id" field.
func InstanceIDNEQ(v uuid.UUID) predicate.InstanceMetadata {
...
func InstanceIDIn(vs ...uuid.UUID) predicate.InstanceMetadata {
...
func InstanceIDNotIn(vs ...uuid.UUID) predicate.InstanceMetadata {
