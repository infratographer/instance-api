...
// UpdateOneID returns an update builder for the given id.
func (c *InstanceProviderClient) UpdateOneID(id uuid.UUID) *InstanceProviderUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *InstanceProviderClient) DeleteOneID(id uuid.UUID) *InstanceProviderDeleteOne {
...
func (c *InstanceProviderClient) Get(ctx context.Context, id uuid.UUID) (*InstanceProvider, error) {
	return c.Query().Where(instanceprovider.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *InstanceProviderClient) GetX(ctx context.Context, id uuid.UUID) *InstanceProvider {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
func (c *InstanceProviderClient) mutate(ctx context.Context, m *InstanceProviderMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("ent: unknown InstanceProvider mutation op: %q", m.Op())
	}
}
