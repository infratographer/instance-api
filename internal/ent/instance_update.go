...
func (iu *InstanceUpdate) AddMetadatumIDs(ids ...uuid.UUID) *InstanceUpdate {
...
func (iu *InstanceUpdate) RemoveMetadatumIDs(ids ...uuid.UUID) *InstanceUpdate {
...
func (iu *InstanceUpdate) check() error {
	...
	if _, ok := iu.mutation.InstanceProviderID(); iu.mutation.InstanceProviderCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Instance.instance_provider"`)
	}
	return nil
}
...
// AddMetadatumIDs adds the "metadata" edge to the InstanceMetadata entity by IDs.
func (iuo *InstanceUpdateOne) AddMetadatumIDs(ids ...uuid.UUID) *InstanceUpdateOne {
...
// RemoveMetadatumIDs removes the "metadata" edge to InstanceMetadata entities by IDs.
func (iuo *InstanceUpdateOne) RemoveMetadatumIDs(ids ...uuid.UUID) *InstanceUpdateOne {
