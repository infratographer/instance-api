...
import (
	...
	dbm "go.infratographer.com/instance-api/db"
	"go.infratographer.com/instance-api/internal/config"
)

const appName = "instance-api"
...
var rootCmd = &cobra.Command{
	Use:   appName,
	Short: "A utility for managing instance definitions",
	Long:  `instance-api is a service for managing abstract instance relationships`,
}
...
func initConfig() {
	...
	viper.SetEnvPrefix("instanceapi")
